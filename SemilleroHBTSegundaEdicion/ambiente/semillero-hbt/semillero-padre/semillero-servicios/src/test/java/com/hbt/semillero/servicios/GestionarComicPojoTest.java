...
public class GestionarComicPojoTest {
	...
	public void PUeliminar() {
		...
		g.agregarListDTO(g.CrearComicDTO("1", "Dragon Ball Yamcha", "Planeta Comic", TematicaEnum.AVENTURAS.name(), "Manga Shonen", 
				144, new BigDecimal(2100), "Dragon Garow Lee", Boolean.FALSE, LocalDate.now(), 
				EstadoEnum.ACTIVO.name(), 20l));
		g.agregarListDTO(g.CrearComicDTO("2", "Captain America Corps 1-5 USA", "Panini Comics", TematicaEnum.FANTASTICO.name(), "BIBLIOTECA MARVEL", 
				128, new BigDecimal(5000), "Phillippe Briones, Roger Stern", Boolean.FALSE, LocalDate.now(), 
				EstadoEnum.ACTIVO.name(), 5l));
		g.agregarListDTO(g.CrearComicDTO("3", "The Spectacular Spider-Man v2 USA", "Panini Comics", TematicaEnum.FANTASTICO.name(), "MARVEL COMICS", 
